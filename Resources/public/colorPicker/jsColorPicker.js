...
jsColorPicker.prototype.createColorPicker = function () {
    ...
    var imgBase = '/bundles/m3ipaint/colorPicker';
    ...
    }, ['DIV',
    {
        ...
        ['DIV',
        {
            style: 'border:1px solid #000;width:397px;height:305px;position:relative;background-color:#E0DFE3;',
            ref: 'fColorPicker'
        }, ['DIV',
        {
            ...
            ['IMG',
            {
                ...
                width: 256,
                height: 256,
                style: 'cursor:crosshair;position:absolute;top:22px;left:10px;',
                galleryimg: 'no',
                ref: 'fColorImg',
                onmousedown: function (evt) {
            ...
            ['IMG',
            {
                ...
                width: 23,
                height: 260,
                style: 'cursor:pointer;position:absolute;top:20px;left:280px;z-index:2;',
                ref: 'colorSlider',
                onmousedown: function (evt) {
            ...
            ['IMG',
            {
                ...
                width: 41,
                height: 9,
                style: 'cursor:pointer;position:absolute;top:18px;left:271px;z-index:1;',
                ref: 'Arrows',
                onmousedown: function (evt) {
                    return _this.cpSliderMouseDown(_this, evt);
                },
            ...
            ['IMG',
            {
                ...
                width: 62,
                height: 70,
                style: 'position:absolute;top:20px;left:315px;'
            }],
            ['IMG',
            {
                src: imgBase + '/cp_web_safe.gif',
                width: 14,
                height: 28,
                style: 'cursor:pointer;position:absolute;top:62px;left:380px;',
                alt: 'Click to Select Web Safe Color',
                ref: 'websafeImg',
                onclick: function (evt) {
                    _this.selectWebSafeColor(_this, evt);
                }
            }],
            ['DIV',
            {
                style: 'z-index:2;position:absolute;top:22px;left:317px;width:58px;height:33px;',
                ref: 'curColorDiv'
            }],
            ['DIV',
            {
                style: 'z-index:2;cursor:pointer;position:absolute;top:55px;left:317px;width:58px;height:33px;',
                ref: 'OrigColorDiv',
                onclick: function (evt) {
            ...
            ['DIV',
            {
                style: 'position:absolute;top:103px;left:315px;'
            }, 'R:'],
            ['DIV',
            {
                style: 'position:absolute;top:128px;left:315px;'
            }, 'G:'],
            ['DIV',
            {
                style: 'position:absolute;top:153px;left:315px;'
            }, 'B:'],
            ['DIV',
            {
                style: 'position:absolute;top:183px;left:315px;'
            }, '#:'],
            ['INPUT',
            {
                style: 'font:12px arial;position:absolute;top:100px;left:330px;width:47px;',
                ref: 'rInput',
            ...
            ['INPUT',
            {
                style: 'font:12px arial;position:absolute;top:125px;left:330px;width:47px;',
                ref: 'gInput',
                onchange: function (evt) {
                    _this.setCPColor(_this, evt);
                }
            ...
            ['INPUT',
            {
                style: 'font:12px arial;position:absolute;top:150px;left:330px;width:47px;',
                ref: 'bInput',
                onchange: function (evt) {
                    _this.setCPColor(_this, evt);
                }
            ...
            ['INPUT',
            {
                style: 'font:12px arial;position:absolute;top:180px;left:330px;width:47px;',
                ref: 'rgbInput',
                onchange: function (evt) {
                    _this.setCPColor(_this, evt);
                }
            ...
            ['BUTTON',
            {
                style: 'position:absolute;bottom:50px;left:315px;width:77px;',
                ref: 'OK',
                onclick: function (evt) {
                    _this.hColorPickerMouseDown(_this, evt);
                }
            ...
            ['BUTTON',
            {
                style: 'position:absolute;bottom:25px;left:315px;width:77px;',
                ref: 'Cancel',
                onclick: function (evt) {
            ...
            {
                type: 'checkbox',
                style: 'position:absolute;top:280px;left:4px;',
                ref: 'websafeCheckbox'
            }],
            ['DIV',
            {
                style: 'position:absolute;top:284px;left:25px;'
            }, 'Only Web Colors'],
            ['IMG',
            {
                src: imgBase + '/cp_mini_icon.png',
