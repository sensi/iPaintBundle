...
iPaintApp.prototype.save = function(sFilename,sFormat,sUserID,fnOK){
   ...
   $.ajax({
      url:"/bundles/m3ipaint/save_image.php",
      data:ajaxData,
      dataType:"json",
      type:"POST",
      cache:false,
...
iPaintApp.prototype.openNewImageDialog = function(w,h){
   ...
   return new jsWindow(this.winMgr)
      ...
      .load("/bundles/m3ipaint/dialog/new-image.html",
            function(jWin,sHTML){
               var oFormInitValue = 
                              {
                                 image_name      : "Untitled",
...
iPaintApp.prototype.openSaveImageDialog = function(){
   ...
   return new jsWindow(this.winMgr)
      ...
      .load("/bundles/m3ipaint/dialog/save-image.html",
            function(jWin,sHTML){
               var oFormInitValue = 
                              {
...
iPaintApp.prototype.openShareImageDialog = function(){
   ...
   return new jsWindow(this.winMgr)
      ...
      .load("/bundles/m3ipaint/dialog/share-image.html",
            function(jWin,sHTML){
               var oFormInitValue = 
                              {
                                 email_list      : sEmails,
...
iPaintApp.prototype.openURLDialog = function(){
   ...
   new jsWindow(this.winMgr)
      ...
      .load("/bundles/m3ipaint/dialog/open-url.html",
            function(jWin,sHTML){
...
iPaintApp.prototype.openGalleryDialog = function(){
   ...
   new jsWindow(this.winMgr)
      ...
      .load("/bundles/m3ipaint/dialog/open-gallery.html",
            function(jWin,sHTML){
...
iPaintApp.prototype.openResizeDialog = function(){
   ...
   return new jsWindow(this.winMgr)
      ...
      .load("/bundles/m3ipaint/dialog/resize.html",
            function(jWin,sHTML){
               var oFormInitValue = 
                              {
                                 resize_by : "per",
...
iPaintApp.prototype.openRotateDialog = function(){
   ...
   return new jsWindow(this.winMgr)
      ...
      .load("/bundles/m3ipaint/dialog/rotate.html",
            function(jWin,sHTML){
               var oFormInitValue = 
                              {
                                 rotate    : "90",
...
iPaintApp.prototype.openAboutDialog = function(){
   ...
   new jsWindow(this.winMgr)
      ...
      .load("/bundles/m3ipaint/dialog/about-ipaint.html",
            function(jWin,sHTML){
            }
      );
};
